...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaStaylinked, FaTwitter } from "react-icons/fa";

const Footer = () => {
  return (
    <div className="mx-auto w-full">
      <footer className="footer p-10 border-b bg-neutral text-neutral-content">
        ...
        <div className="border p-10 rounded-full text-center">
         ...
         <div className="flex gap-3 mt-3 mx-auto">
            <a className="border rounded-full p-2 hover:border-indigo-500" href=""><FaFacebookF/></a>
            <a className="border rounded-full hover:border-indigo-500 p-2" href=""><FaInstagram/></a>
            <a className="border rounded-full hover:border-indigo-500 p-2" href=""><FaTwitter/></a>
            <a className="border rounded-full hover:border-indigo-500 p-2" href=""><FaLinkedinIn/></a>
          </div>
        </div>
        <div className="text-white font-bold py-5">
          <span className="footer-title">Address Info</span>
          <a className="link link-hover"><span className="text-orange-300">Phone: </span>
+880-1637131835</a>
          <a className="link link-hover"><span className="text-orange-300">Email: </span>
gastonomic.journey@gmail.com</a>
          <a className="link link-hover"><span className="text-orange-300">Fax Id: </span>
+025789613</a>
          <a className="link link-hover"><span className="text-orange-300">Location: </span>Chasara,Balurmath,Narayanganj</a>
        </div>
      </footer>
      ...
      <footer className="footer px-10 py-4  bg-neutral text-neutral-content">
        <div className="items-center grid-flow-col">
          <p>
          &copy; Copyright by Gastonomic Journey, All Right Reserved.
          </p>
        </div>
